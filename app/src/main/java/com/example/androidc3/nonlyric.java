...
public class nonlyric extends AppCompatActivity {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nonlyric);
        ...
        String videoPath="android.resource://"+getPackageName() + "/" + intent.getIntExtra("nonvocal", 0);
